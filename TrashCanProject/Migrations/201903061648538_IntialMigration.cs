namespace TrashCanProject.Migrations
{
    ...
    public partial class IntialMigration : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        TrashCanSchedule_ID = c.Int(),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.Customers", t => t.CustomerId, cascadeDelete: true)
                .ForeignKey("dbo.TrashCanSchedules", t => t.TrashCanSchedule_ID)
                .Index(t => t.CustomerId)
                .Index(t => t.TrashCanSchedule_ID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.TrashCanSchedules", "CustomerId", "dbo.Customers");
            ...
            DropIndex("dbo.TrashCanSchedules", new[] { "CustomerId" });
            ...
            DropTable("dbo.TrashCanSchedules");
